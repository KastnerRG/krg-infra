...
in {
  ...
  #
  # MLflow and Outline are now on vault-agent too (renders /run/krg/mlflow/{db,mlflow}.env
  # and /run/krg/outline/{db,outline}.env from terraform/secrets-generated values) —
  # both take NO .secrets/ file.
  #
  # Still hand-placed in /var/lib/krg/krg-prod/.secrets/ (not yet migrated):
